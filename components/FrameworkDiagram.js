...
export default function FrameworkDiagram(props){
    return(
        <div className='flex flex-col gap-4'>
                        ...
                        <div className="col-span-5 md:col-span-4  bg-white rounded-lg py-4 ">
                            <div className="grid grid-cols-4 gap-3 md:gap-6 justify-center md:px-16">
                                {technologies.map((elem, i)=>(
                                    <div key={i} className={`col-span-2 md:col-span-1 flex flex-col items-center gap-2 ${i%2 && i > 0? 'md:mt-4' : ''}`}>
                                        <Image src={elem.src} alt={elem.title} width={52} height={52} className="h-12 w-12" />
                                    </div>
                                ))}
                            </div>
                        </div>
            ...
            <div className='grid grid-cols-8  gap-y-6 md:gap-x-16 md:gap-y-12 bg-[#03BEFE] rounded-lg px-4 md:px-8 py-4'>
                <span className="col-span-8 md:col-span-2 text-white font-medium text-center md:text-left">Cloud servers</span>
                    ...
                    <div className="col-span-8 md:col-span-6 grid grid-cols-5 gap-4">
                        <div className="col-span-5 col-start-1 md:col-span-4 md:col-start-2 flex gap-6 bg-white rounded-lg py-4 justify-center">
                            <div className="flex items-center gap-8">
                                <Image src="/technologies/aws.svg" alt="aws logo" width={304} height={182} className="w-16" />
                                <div className="h-full w-[2px] bg-gray-200"></div>
                                <Image src="/technologies/ovh.svg" alt="aws logo" width={270} height={172} className="w-16" />
