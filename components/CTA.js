    ...
    return (
        <section className='wrapper py-24 max-w-5xl'>
          <div className='flex flex-col items-center justify-center gap-4'>
            ...
            <p className='sm:text-center sm:max-w-2xl sm:mx-auto'>Are you interested in OwlGrid? Follow our journey on LinkedIn to stay informed of the product development!</p>
          </div>
